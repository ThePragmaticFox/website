...
const _007313 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _ab2c5e, lazy: true, method: undefined },
  { route: '/__nuxt_error', handler: _007313, lazy: true, method: undefined },
  { route: '/**', handler: _007313, lazy: true, method: undefined }
];
